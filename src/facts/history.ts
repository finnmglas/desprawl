...
import { COMMIT_MAX, LOG_MAX, git } from "../read/model.ts"
import { SIGNERS } from "./stack.ts"
import type { Churn, Commit, Contributor, Series } from "../read/model.ts"
...
export const believable = (seconds: number): boolean =>
